...
## 🧪 Tests
*(añade info si tienes tests unitarios o de integración)*

## 🤝 Contribuciones
¡Bienvenidos los pull requests!  
Por favor:
- Fork + branch descriptivo
- Código limpio, con tests si es posible
- Detalla cambios en PR
- Usa el estilo de codificación actual

## 📄 Licencia
Licenciado bajo **CC-BY-SA**. Incluye atribución al autor y comparte cambios bajo la misma licencia.
